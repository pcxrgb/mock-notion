...
export default function DocPage() {
  ...
  return (
    ...
    >
      <div className="hidden md:flex h-full w-1/5 min-w-[240px] flex-col rounded-2xl px-5 py-6 bg-white/5">
      ...
      <div className={`md:hidden h-full flex-1 overflow-auto rounded-2xl px-10 py-8 ${docList[0] ? "bg-white text-neutral-900" : "bg-white/10 text-neutral-200"}`}>
        <div className="mx-auto max-w-[900px]">
          {!docList[0] ? (
            <h1 className="text-2xl font-semibold">No document</h1>
          ) : (
            <>
              <h1 className="text-3xl font-bold">{docList[0].title}</h1>
              <p className="mt-4 text-[16px] leading-7">
                This document captures the current state of work, decisions, and action items.
                It is intended to be a living document that reflects ongoing progress and aligns the team.
              </p>
              ...
              <p className="mt-3 text-[16px] leading-7">
                ...
                <br />- Maintain a flexible architecture to support rapid iteration.
              </p>
      ...
      <div className={`hidden md:block h-full flex-1 overflow-auto rounded-2xl px-10 py-8 ${currentIdx != null ? "bg-white text-neutral-900" : "bg-white/10 text-neutral-200"}`}>
        <div className="mx-auto max-w-[900px]">
          {currentIdx == null || !docList[currentIdx] ? (
            <h1 className="text-2xl font-semibold">No document</h1>
          ) : (
            <>
              <h1 className="text-3xl font-bold">{docList[currentIdx].title}</h1>
              <p className="mt-4 text-[16px] leading-7">
                This document captures the current state of work, decisions, and action items.
                It is intended to be a living document that reflects ongoing progress and aligns the team.
              </p>
